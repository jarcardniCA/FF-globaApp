...
// Future reorderableResultcidosItem(
//   List<ResultadosRecord> list,
//   int ondIndex,
//   int newIndex,
// ) // Automatic FlutterFlow imports
// async {
//   // If the item is being moved down the list, we adjust the newIndex.
//   if (ondIndex < newIndex) {
//     newIndex -= 1;
//   }

//   // Remove the item from its current position in the list.
//   final ResultadosRecord item = list.removeAt(ondIndex);
...
//     final ResultadosRecord doc = list[i];
...
Future reorderableResultcidosItem(
  ...
  // Remove the item from its current position in the list.
  final ResultadosRecord item = list.removeAt(oldIndex);

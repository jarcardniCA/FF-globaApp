...
class CreateQuestionCopyWidget extends StatefulWidget {
  const CreateQuestionCopyWidget({super.key});

  @override
  State<CreateQuestionCopyWidget> createState() =>
                            ...
                            children: [
                              Padding(
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'CREATE_QUESTION_COPY_Icon_bz0cwalo_ON_TA');
                              ...
                              child: Column(
                                ...
                                children: [
                                    ...
                                    builder: (context, snapshot) {
                                      ...
                                      return FlutterFlowDropDown<String>(
                                        ...
                                        onChanged: (val) async {
                                          ...
                                          logFirebaseEvent(
                                              'CREATE_QUESTION_COPY_DropDown_dvpi5kp8_O');
                                          logFirebaseEvent(
                                    ...
                                    builder: (context, snapshot) {
                                      ...
                                      return FlutterFlowDropDown<String>(
                                        ...
                                        onChanged: (val) async {
                                          ...
                                          logFirebaseEvent(
                                              'CREATE_QUESTION_COPY_DropDown_frsorglb_O');
                                          logFirebaseEvent(
                                              'DropDown_update_page_state');
                                  ...
                                  wrapWithModel(
                                    ...
                                    child: FormAnswerWidget(
                                      ...
                                      onAnswerTypeChange: (answerType, score,
                                        ...
                                        logFirebaseEvent(
                                            'CREATE_QUESTION_COPY_Container_9rv9m61d_');
                                        logFirebaseEvent(
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      FlutterFlowIconButton(
                                        ...
                                        onPressed: () async {
                                          logFirebaseEvent(
                                              'CREATE_QUESTION_COPY_info_outline_ICN_ON');
                                          logFirebaseEvent(
                                        ...
                                        children: [
                                          if (valueOrDefault<String>(
                                            ...
                                            InkWell(
                                              ...
                                              onTap: () async {
                                                logFirebaseEvent(
                                                    'CREATE_QUESTION_COPY_Image_lwzvle7z_ON_T');
                                                logFirebaseEvent(
                                                    'Image_expand_image');
                                          ...
                                          FFButtonWidget(
                                            onPressed: () async {
                                              logFirebaseEvent(
                                                  'CREATE_QUESTION_COPY_SUBIR_FOTO_BTN_ON_T');
                                              logFirebaseEvent(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          FFButtonWidget(
                                            onPressed: () async {
                                              logFirebaseEvent(
                                                  'CREATE_QUESTION_COPY_SUBIR_VIDEO_BTN_ON_');
                                              logFirebaseEvent(
                                                  'Button_upload_media_to_firebase');
                                              final selectedMedia =
                                                  await selectMediaWithSourceBottomSheet(
                                  ...
                                  FFButtonWidget(
                                    onPressed: () async {
                                      logFirebaseEvent(
                                          'CREATE_QUESTION_COPY_CREAR_PREGUNTA_BTN_');

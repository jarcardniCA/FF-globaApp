...
class AgregarCategoriaWidget extends StatefulWidget {
  ...
  final FormacionesRecord? formaciones;
            ...
            Row(
              ...
              children: [
                InkWell(
                  ...
                  onTap: () async {
                    logFirebaseEvent('AGREGAR_CATEGORIA_Icon_7zuyzfqw_ON_TAP');
              ...
              children: [
                Padding(
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      logFirebaseEvent('AGREGAR_CATEGORIA_GUARDAR_BTN_ON_TAP');
                      ...
                      await CategoriasRecord.collection
                          ...
                          .set(createCategoriasRecordData(
                            ...
                            formarcionesRef: widget.formaciones?.reference,
                            order:

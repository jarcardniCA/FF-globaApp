...
class _LoginAdminWidgetState extends State<LoginAdminWidget>
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'Login_admin'});
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  logFirebaseEvent(
                                      'LOGIN_ADMIN_RichText_4chswidp_ON_TAP');
                                  logFirebaseEvent('RichText_navigate_to');

                                  context.pushNamed('restaurar_password_admin');
                                },
                                child: RichText(
                            ...
                            FFButtonWidget(
                              onPressed: () async {
                                logFirebaseEvent(
                                    'LOGIN_ADMIN_INICIAR_SESION_BTN_ON_TAP');

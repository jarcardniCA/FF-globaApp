...
import 'editar_cursos_fix_model.dart';
export 'editar_cursos_fix_model.dart';

class EditarCursosFixWidget extends StatefulWidget {
  const EditarCursosFixWidget({
    super.key,
    required this.quiz,
    required this.quizz,
    required this.index,
  ...
  @override
  State<EditarCursosFixWidget> createState() => _EditarCursosFixWidgetState();
}

class _EditarCursosFixWidgetState extends State<EditarCursosFixWidget> {
  late EditarCursosFixModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditarCursosFixModel());

    // On component load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('EDITAR_CURSOS_FIX_editar_cursosFix_ON_IN');
      logFirebaseEvent('editar_cursosFix_set_form_field');
      safeSetState(() {
        _model.seleccionarTipoValueController?.value =
            'Opción múltiple con multimedia';
      });
      logFirebaseEvent('editar_cursosFix_update_component_state');
      _model.answerList =
      ...
      _model.updatePage(() {});
      logFirebaseEvent('editar_cursosFix_update_app_state');
                                  ...
                                  if (responsiveVisibility(
                                    ...
                                    FlutterFlowDropDown<String>(
                                      ...
                                      onChanged: (val) async {
                                        ...
                                        logFirebaseEvent(
                                            'EDITAR_CURSOS_FIX_seleccionar_tipo_ON_FO');
                                        logFirebaseEvent(
                                    ...
                                    child: wrapWithModel(
                                      ...
                                      child: EditarAnswerWidget(
                                        ...
                                        onAnswerTypeChange: (answerType, score,
                                          ...
                                          logFirebaseEvent(
                                              'EDITAR_CURSOS_FIX_Container_umi3zhvq_CAL');
                                          logFirebaseEvent(
                                                          ...
                                                          wrapWithModel(
                                                            ...
                                                            child:
                                                              ...
                                                              answerSelectedIndex:
                                                                  _model
                                                                      .answerCorrectIndex,
                                                              imageCuadrante: _model.editarAnswerModel
                                                                              .uploadedFileUrl1 !=
                                                                          ''
                                                                  ? _model
                                                                      .editarAnswerModel
                                                                      .uploadedFileUrl1
                                                                  : (widget.allQuestionList![
                                                                          widget
                                                                              .index!])
                                                                      .imageUrl,
                                                              full: false,
                                                              onSelect:
                                                                ...
                                                                logFirebaseEvent(
                                                                    'EDITAR_CURSOS_FIX_editarSelection_CALLBA');
                                                                logFirebaseEvent(
            ...
            children: [
              Padding(
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    logFirebaseEvent('EDITAR_CURSOS_FIX_CANCELAR_BTN_ON_TAP');
              ...
              Padding(
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    logFirebaseEvent('EDITAR_CURSOS_FIX_GUARDAR_BTN_ON_TAP');
                      ...
                      _model.updateUpdatedQuestionDataAtIndex(
                        ...
                        (_) => QuestionStruct(
                          ...
                          imageUrl: _model.editarAnswerModel.uploadedFileUrl1 !=
                                      ''
                              ? _model.editarAnswerModel.uploadedFileUrl1
                              : ((widget.allQuestionList?[widget.index!])
                                  ?.imageUrl),
                          videoUrl: _model.editarAnswerModel.uploadedFileUrl2,
                          errorMessage:
                              _model.mensajeIncorrectoTextController.text,
                          type: _model.answerType,
                          answerList: functions.listAnswersCuadrantes(_model
                              .editarAnswerModel.dropDownCuadrantesValue!
                              .toList()),

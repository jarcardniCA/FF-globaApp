...
import 'creador_cursos_fix_model.dart';
export 'creador_cursos_fix_model.dart';

class CreadorCursosFixWidget extends StatefulWidget {
  const CreadorCursosFixWidget({
    super.key,
    required this.quiz,
  });
  ...
  @override
  State<CreadorCursosFixWidget> createState() => _CreadorCursosFixWidgetState();
}

class _CreadorCursosFixWidgetState extends State<CreadorCursosFixWidget> {
  late CreadorCursosFixModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreadorCursosFixModel());

    // On component load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('CREADOR_CURSOS_FIX_creador_cursosFix_ON_');
      logFirebaseEvent('creador_cursosFix_set_form_field');
      safeSetState(() {
        _model.seleccionarTipoValueController?.value =
            'Opción múltiple con multimedia';
      });
      logFirebaseEvent('creador_cursosFix_update_component_state');
      _model.answerList = FFAppState()
          .defaultAnswerForSimpleSelection
          .toList()
          .cast<AnswerStruct>();
      _model.answerType = QuestionType.SIMPLE_SELECTION.name;
      _model.updatePage(() {});
      logFirebaseEvent('creador_cursosFix_update_app_state');
                                  ...
                                  if (responsiveVisibility(
                                    ...
                                    FlutterFlowDropDown<String>(
                                      ...
                                      onChanged: (val) async {
                                        ...
                                        logFirebaseEvent(
                                            'CREADOR_CURSOS_FIX_seleccionar_tipo_ON_F');
                                        logFirebaseEvent(
                              ...
                              child: wrapWithModel(
                                ...
                                child: FormAnswerWidget(
                                  ...
                                  onAnswerTypeChange: (answerType, score,
                                    ...
                                    logFirebaseEvent(
                                        'CREADOR_CURSOS_FIX_Container_pycxjudz_CA');
                                    logFirebaseEvent(
                                                  ...
                                                  child: wrapWithModel(
                                                    ...
                                                    child:
                                                      ...
                                                      onSelect:
                                                        ...
                                                        logFirebaseEvent(
                                                            'CREADOR_CURSOS_FIX_Container_lvo6ikat_CA');
                                                        logFirebaseEvent(
            ...
            children: [
              Padding(
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    logFirebaseEvent('CREADOR_CURSOS_FIX_CANCELAR_BTN_ON_TAP');
              ...
              Padding(
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    logFirebaseEvent('CREADOR_CURSOS_FIX_GUARDAR_BTN_ON_TAP');
                    if (_model.answerType == 'CUADRANTE') {
                      logFirebaseEvent('Button_backend_call');

                      await widget.quiz!.reference.update({
                        ...mapToFirestore(
                          {

...
import 'editar_answer_copy_model.dart';
export 'editar_answer_copy_model.dart';

class EditarAnswerCopyWidget extends StatefulWidget {
  const EditarAnswerCopyWidget({
    super.key,
  ...
  @override
  State<EditarAnswerCopyWidget> createState() => _EditarAnswerCopyWidgetState();
}

class _EditarAnswerCopyWidgetState extends State<EditarAnswerCopyWidget> {
  late EditarAnswerCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditarAnswerCopyModel());

    // On component load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('EDITAR_ANSWER_COPY_editarAnswerCopy_ON_I');
      logFirebaseEvent('editarAnswerCopy_update_component_state');
      _model.componentAnswerList =
          widget.answerList!.toList().cast<AnswerStruct>();
      _model.answerType = widget.question!.type;
      safeSetState(() {});
      logFirebaseEvent('editarAnswerCopy_execute_callback');
          ...
          children: [
            ...
            FlutterFlowDropDown<String>(
              ...
              onChanged: (val) async {
                ...
                logFirebaseEvent('EDITAR_ANSWER_COPY_DropDown_ac1fjosh_ON_');
              ...
              children: [
                if (responsiveVisibility(
                  ...
                  FlutterFlowIconButton(
                    ...
                    onPressed: () async {
                      logFirebaseEvent(
                          'EDITAR_ANSWER_COPY_info_outline_ICN_ON_T');
                ...
                child: Column(
                  ...
                  children: [
                    if ((widget.answerType ==
                            QuestionType.CUADRANTE.name) ||
                        (_model.dropDownValue == 'CUADRANTE'))
                      Column(
                        mainAxisSize: MainAxisSize.max,
                                ...
                                children: [
                                  Expanded(
                                    child: FFButtonWidget(
                                      onPressed: () async {
                                        logFirebaseEvent(
                                            'EDITAR_ANSWER_COPY_FOTO_SUBIR_ON_TAP');
                                        logFirebaseEvent(
                                  ...
                                  Expanded(
                                    child: Padding(
                                      ...
                                      child: FFButtonWidget(
                                        onPressed: () async {
                                          logFirebaseEvent(
                                              'EDITAR_ANSWER_COPY_VIDEO_SUBIR_ON_TAP');
                                          logFirebaseEvent(
                                      ...
                                      children: [
                                        Expanded(
                                          child: InkWell(
                                            ...
                                            onTap: () async {
                                              logFirebaseEvent(
                                                  'EDITAR_ANSWER_COPY_Row_ixfxtmmm_ON_TAP');
                                              logFirebaseEvent(
                                        ...
                                        Builder(
                                          builder: (context) =>
                                            ...
                                            onPressed: () async {
                                              logFirebaseEvent(
                                                  'EDITAR_ANSWER_COPY_COMP_edit_ICN_ON_TAP');
                                              logFirebaseEvent(
                                  ...
                                  return ListView.separated(
                                    ...
                                    itemBuilder:
                                      ...
                                      return InkWell(
                                        ...
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'EDITAR_ANSWER_COPY_Container_8mjmu978_ON');
                                          logFirebaseEvent(
                                ...
                                return ListView.separated(
                                  ...
                                  itemBuilder: (context, imageSelectionIndex) {
                                    ...
                                    return InkWell(
                                      ...
                                      onTap: () async {
                                        logFirebaseEvent(
                                            'EDITAR_ANSWER_COPY_Container_4l4jnnwn_ON');
                                        logFirebaseEvent(
                                            'Container_execute_callback');
                                        await widget.onSelectAnswerCorrect
                                            ?.call(
                                ...
                                return ListView.separated(
                                  ...
                                  itemBuilder: (context, trueFalseIndex) {
                                    ...
                                    return InkWell(
                                      ...
                                      onTap: () async {
                                        logFirebaseEvent(
                                            'EDITAR_ANSWER_COPY_Row_bp90s7it_ON_TAP');
                                        logFirebaseEvent(
                                            'Row_execute_callback');
                                        await widget.onSelectAnswerCorrect
                                            ?.call(

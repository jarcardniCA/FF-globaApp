import '/administracion/cursos/edit_answer_edit_image/edit_answer_edit_image_widget.dart';
import '/administracion/cursos/editar_answer_edit_text/editar_answer_edit_text_widget.dart';
...
import 'editar_answer_model.dart';
export 'editar_answer_model.dart';

class EditarAnswerWidget extends StatefulWidget {
  const EditarAnswerWidget({
    super.key,
  ...
  @override
  State<EditarAnswerWidget> createState() => _EditarAnswerWidgetState();
}

class _EditarAnswerWidgetState extends State<EditarAnswerWidget> {
  late EditarAnswerModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditarAnswerModel());

    // On component load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('EDITAR_ANSWER_editarAnswer_ON_INIT_STATE');
      logFirebaseEvent('editarAnswer_update_component_state');
      _model.componentAnswerList =
          widget.answerList!.toList().cast<AnswerStruct>();
      _model.answerType = widget.question!.type;
      safeSetState(() {});
      logFirebaseEvent('editarAnswer_execute_callback');
            ...
            Opacity(
              ...
              child: FlutterFlowDropDown<String>(
                ...
                onChanged: (val) async {
                  ...
                  logFirebaseEvent('EDITAR_ANSWER_DropDown_2f7lw6o3_ON_FORM_');
                },
                height: 56.0,
                ...
                hidesUnderline: true,
                disabled:
                    QuestionType.values.contains(QuestionType.SIMPLE_SELECTION),
                isOverButton: true,
                isSearchable: false,
                isMultiSelect: false,
              ),
              ...
              children: [
                if (responsiveVisibility(
                  ...
                  FlutterFlowIconButton(
                    ...
                    onPressed: () async {
                      logFirebaseEvent('EDITAR_ANSWER_info_outline_ICN_ON_TAP');
                              ...
                              children: [
                                Expanded(
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      logFirebaseEvent(
                                          'EDITAR_ANSWER_COMP_FOTO_SUBIR_ON_TAP');
                                      logFirebaseEvent(
                          ...
                          Opacity(
                            ...
                            child: FlutterFlowDropDown<String>(
                              ...
                              onMultiSelectChanged: (val) async {
                                ...
                                logFirebaseEvent(
                                    'EDITAR_ANSWER_DropDownCuadrantes_ON_FORM');
                                logFirebaseEvent(
                                    'DropDownCuadrantes_update_component_stat');
                                ...
                                if (_model.answerType ==
                                  ...
                                  safeSetState(() {});
                                  logFirebaseEvent(
                                      'DropDownCuadrantes_execute_callback');
                                  await widget.onChangeAnswerList?.call(
                                    _model.componentAnswerList,
                                  );
                                  logFirebaseEvent(
                                ...
                                logFirebaseEvent(
                                    'DropDownCuadrantes_update_app_state');
                                ...
                                Expanded(
                                  child: Padding(
                                    ...
                                    child: FFButtonWidget(
                                      onPressed: () async {
                                        logFirebaseEvent(
                                            'EDITAR_ANSWER_COMP_VIDEO_SUBIR_ON_TAP');
                                        logFirebaseEvent(
                                      ...
                                      children: [
                                        Expanded(
                                          child: InkWell(
                                            ...
                                            onTap: () async {
                                              logFirebaseEvent(
                                                  'EDITAR_ANSWER_COMP_Row_91ivnmpj_ON_TAP');
                                              logFirebaseEvent(
                                        ...
                                        Builder(
                                          builder: (context) =>
                                            ...
                                            onPressed: () async {
                                              logFirebaseEvent(
                                                  'EDITAR_ANSWER_COMP_edit_ICN_ON_TAP');
                                              logFirebaseEvent(
                                              ...
                                              await widget.onChangeAnswer?.call(
                                  ...
                                  return ListView.separated(
                                    ...
                                    itemBuilder:
                                      ...
                                      return InkWell(
                                        ...
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'EDITAR_ANSWER_Container_ulihvua7_ON_TAP');
                                          logFirebaseEvent(
                                ...
                                return ListView.separated(
                                  ...
                                  itemBuilder: (context, imageSelectionIndex) {
                                    ...
                                    return InkWell(
                                      ...
                                      onTap: () async {
                                        logFirebaseEvent(
                                            'EDITAR_ANSWER_Container_94fx6npf_ON_TAP');
                                        logFirebaseEvent(
                                            'Container_execute_callback');
                                        await widget.onSelectAnswerCorrect
                                            ?.call(
                                ...
                                return ListView.separated(
                                  ...
                                  itemBuilder: (context, trueFalseIndex) {
                                    ...
                                    return InkWell(
                                      ...
                                      onTap: () async {
                                        logFirebaseEvent(
                                            'EDITAR_ANSWER_COMP_Row_8vwiibbf_ON_TAP');
                                        logFirebaseEvent(
                                            'Row_execute_callback');
                                        await widget.onSelectAnswerCorrect
                                            ?.call(

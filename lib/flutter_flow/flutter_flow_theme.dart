...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF69639D);
  late Color secondary = const Color(0xFFA47FFD);
  late Color tertiary = const Color(0xFF4D4F57);
  late Color alternate = const Color(0xFFE0E3E7);
  late Color primaryText = const Color(0xFF1F2129);
  late Color secondaryText = const Color(0xFF18181E);
  late Color primaryBackground = const Color(0xFFF2F2F2);
  late Color secondaryBackground = const Color(0xFF4C4F57);
  late Color accent1 = const Color(0xFF989BB0);

...
class _RankingWidgetState extends State<RankingWidget>
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'ranking'});
                      ...
                      Expanded(
                        child: Padding(
                          ...
                          child: FlutterFlowChoiceChips(
                            options: const [
                              ChipData('Ultimos 30 dias'),
                              ChipData('Últimos 15 días'),
                              ChipData('Últimos 7 días')
                            ],
                    ...
                    children: [
                      if (_model.choiceChipsValue != null &&
                        ...
                        InkWell(
                          ...
                          onTap: () async {
                            logFirebaseEvent(
                                'RANKING_PAGE_Text_7weyd5d8_ON_TAP');
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        if (_model.choiceChipsValue == 'Últimos 15 días')
                          StreamBuilder<List<UsersRecord>>(
                            stream: queryUsersRecord(
                              queryBuilder: (usersRecord) => usersRecord.where(
                                'last_quizz_answered_date',
                                isGreaterThan: functions.daysubstract(15),
                              ),
                            ),
                            builder: (context, snapshot) {
                              // Customize what your widget looks like when it's loading.
                              ...
                              return Container(
                                ...
                                child: Padding(
                                  ...
                                  child: Builder(
                                    builder: (context) {
                                      final day15 = containerUsersRecordList
                                          .sortedList(
                                              keyOf: (e) => e.score, desc: true)
                                          .toList();
                                      if (day15.isEmpty) {
                                      ...
                                      return ListView.separated(
                                        padding: EdgeInsets.zero,
                                        scrollDirection: Axis.vertical,
                                        itemCount: day15.length,
                                        separatorBuilder: (_, __) =>
                                            const SizedBox(height: 15.0),
                                        itemBuilder: (context, day15Index) {
                                          final day15Item = day15[day15Index];
                                          return Padding(
                                            padding:
                                                const EdgeInsetsDirectional.fromSTEB(
                                                    16.0, 0.0, 16.0, 0.0),
                        ...
                        if (_model.choiceChipsValue == 'Ultimos 30 dias')
                          StreamBuilder<List<UsersRecord>>(
                            stream: queryUsersRecord(
                              queryBuilder: (usersRecord) => usersRecord.where(
                                'last_quizz_answered_date',
                                isGreaterThan: functions.daysubstract(30),
                              ),
                            ),
                            builder: (context, snapshot) {
                              // Customize what your widget looks like when it's loading.
                              ...
                              return Container(
                                ...
                                child: Padding(
                                  ...
                                  child: Builder(
                                    builder: (context) {
                                      final day30 = containerUsersRecordList
                                          .sortedList(
                                              keyOf: (e) => e.score, desc: true)
                                          .toList();
                                      if (day30.isEmpty) {
                                      ...
                                      return ListView.separated(
                                        padding: EdgeInsets.zero,
                                        scrollDirection: Axis.vertical,
                                        itemCount: day30.length,
                                        separatorBuilder: (_, __) =>
                                            const SizedBox(height: 15.0),
                                        itemBuilder: (context, day30Index) {
                                          final day30Item = day30[day30Index];
                                          return Padding(
                                            padding:
                                                const EdgeInsetsDirectional.fromSTEB(
                                                    16.0, 0.0, 16.0, 0.0),
                        ...
                        if (_model.choiceChipsValue == 'Últimos 7 días')
                          StreamBuilder<List<UsersRecord>>(
                            stream: queryUsersRecord(
                              queryBuilder: (usersRecord) => usersRecord.where(
                                'last_quizz_answered_date',
                            ...
                            builder: (context, snapshot) {
                              ...
                              return Container(
                                ...
                                child: Padding(
                                  ...
                                  child: Builder(
                                    builder: (context) {
                                      final day7 = containerUsersRecordList
                                          .sortedList(
                                              keyOf: (e) => e.score, desc: true)
                                          .toList();
                                      if (day7.isEmpty) {
                                      ...
                                      return ListView.separated(
                                        padding: EdgeInsets.zero,
                                        scrollDirection: Axis.vertical,
                                        itemCount: day7.length,
                                        separatorBuilder: (_, __) =>
                                            const SizedBox(height: 15.0),
                                        itemBuilder: (context, day7Index) {
                                          final day7Item = day7[day7Index];
                                          return Padding(
                                            padding:
                                                const EdgeInsetsDirectional.fromSTEB(
                                                    16.0, 0.0, 16.0, 0.0),

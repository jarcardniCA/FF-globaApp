...
class _QuizQuestionWidgetState extends State<QuizQuestionWidget>
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'quizQuestion'});
    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('QUIZ_QUESTION_quizQuestion_ON_INIT_STATE');
      if (FFAppState().userLives == 0) {
        logFirebaseEvent('quizQuestion_alert_dialog');
        await showDialog(
          context: context,
          builder: (alertDialogContext) {
            return AlertDialog(
              title: const Text('No tienes mas vidas'),
              content: const Text('No puedes jugar más'),
              actions: [
                TextButton(
        ...
        logFirebaseEvent('quizQuestion_navigate_to');

        context.goNamed('temas');
      }
    });
            ...
            builder: (context, snapshot) {
              ...
              return Container(
                ...
                child: Padding(
                  ...
                  child: Builder(
                    builder: (context) {
                      final question = containerQuizRecord?.question
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                FlutterFlowIconButton(
                                                  ...
                                                  onPressed: () async {
                                                    logFirebaseEvent(
                                                        'QUIZ_QUESTION_PAGE_close_ICN_ON_TAP');
                                                    logFirebaseEvent(
                                              ...
                                              if ((questionItem.help !=
                                                ...
                                                Builder(
                                                  builder: (context) => InkWell(
                                                    ...
                                                    onTap: () async {
                                                      logFirebaseEvent(
                                                          'QUIZ_QUESTION_PAGE_Image_0aebtdf5_ON_TAP');
                                                      logFirebaseEvent(
                                                          'Image_alert_dialog');
                                                      await showDialog(
                                                        context: context,
                                            ...
                                            Align(
                                              ...
                                              child: Container(
                                                ...
                                                child: QuestionMediaWidget(
                                                  key: Key(
                                                      'Keyb14_${questionIndex}_of_${question.length}'),
                                                  imageUrl:
                                    ...
                                    Container(
                                      ...
                                      child: wrapWithModel(
                                        ...
                                        child: AsnwerSelectionWidget(
                                          key: Key(
                                            'Keyaia_${'${containerQuizRecord.reference.id}_${questionIndex.toString()}'}',
                                          ),
                                          ...
                                          onSelect:
                                            ...
                                            logFirebaseEvent(
                                                'QUIZ_QUESTION_Container_aia217q8_CALLBAC');
                                            logFirebaseEvent(
                                    ...
                                    if ((_model.answerSelectedIndex != -1) ||
                                      ...
                                      Padding(
                                        ...
                                        child: FFButtonWidget(
                                          onPressed: () async {
                                            logFirebaseEvent(
                                                'QUIZ_QUESTION_PAGE_CheckButton_ON_TAP');

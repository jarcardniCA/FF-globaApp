    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      if (dateTimeFormat(
        ...
        if (valueOrDefault(currentUserDocument?.tipoUsuario, '') ==
          ...
          logFirebaseEvent('inicio_navigate_back');
          context.safePop();
        }
      }
    });
                                    ...
                                    if (responsiveVisibility(
                                      ...
                                      Padding(
                                        ...
                                        child: InkWell(
                                          ...
                                          onTap: () async {
                                            logFirebaseEvent(
                                                'INICIO_PAGE_Text_vdk4yhm9_ON_TAP');
                              ...
                              Builder(
                                builder: (context) => AuthUserStreamWidget(
                                  builder: (context) => InkWell(
                                    ...
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'INICIO_PAGE_Text_68cig9je_ON_TAP');
                            ...
                            children: [
                              ...
                              if (responsiveVisibility(
                                ...
                                FFButtonWidget(
                                  onPressed: () async {
                                    logFirebaseEvent(
                                        'INICIO_PAGE_CREAR_PREGUNTA_BTN_ON_TAP');
                                            ...
                                            Row(
                                              ...
                                              children: [
                                                ...
                                                InkWell(
                                                  ...
                                                  onTap: () async {
                                                    logFirebaseEvent(
                                                        'INICIO_PAGE_Container_nc8jn62b_ON_TAP');
                                                    logFirebaseEvent(
